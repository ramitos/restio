...
module.exports.listen = function () {
  var server = setup.server(Array.prototype.slice.call(arguments));
  var callbacks = {};
  var io = new ev();
  var routes = {};
  ...
  server.on('connection', function (socket) {
    if(socket.request.headers.cookie) socket.cookies = cookie.parse(socket.request.headers.cookie);
